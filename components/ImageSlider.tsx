    ...
    <div className="relative w-full h-[600px] md:h-[700px] lg:h-[800px] overflow-hidden rounded-lg">
      ...
      <div className="relative w-full h-full">
        ...
        >
          ...
          {/* Text Content */}
          <div className={`absolute inset-0 flex flex-col justify-center items-center text-center px-4 transition-all duration-1000 ${
            isAnimating ? 'translate-y-2 opacity-80' : 'translate-y-0 opacity-100'
          }`}>
            <h1
              className="text-3xl md:text-5xl font-bold mb-4 transition-all duration-1000 transform hover:scale-105"
              style={{ 
                color: colors.cream,
            ...
            <p
              className="text-lg md:text-xl max-w-2xl transition-all duration-1000 transform hover:scale-105"
              style={{ 
                color: colors.cream,
      ...
      <button
        ...
        className="absolute left-4 top-1/2 transform -translate-y-1/2 p-3 rounded-full transition-all duration-300 hover:scale-110 hover:shadow-lg active:scale-95"
      ...
      <button
        onClick={goToNext}
        className="absolute right-4 top-1/2 transform -translate-y-1/2 p-3 rounded-full transition-all duration-300 hover:scale-110 hover:shadow-lg active:scale-95"
        style={{ backgroundColor: colors.cream, color: colors.bordo }}
      >
        <svg
          className="w-6 h-6 transition-transform duration-300 group-hover:translate-x-1"
